// Pay page: check what a plate owes (GET /check_plate/<plate>) and pay
// it (GET /pay/<plate>). The live spots board is handled by spots.js.
...
// --- Hourly rate (needed for the "total due" figure) ---
